    ...
    $error="";
      if (mysqli_num_rows($result)>0)
      {
        while ($row= mysqli_fetch_assoc($result))
        {
          ...
          $sql1="DELETE FROM books WHERE title=$bookname";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                <!-- Tabs Titles -->
                <h2 class="active"> Remove Book </h2>
                    ...
                    <form action="Remove.php" method="post">
                        <input type="text" id="bookname" class="fadeIn second" name="bookname" placeholder="BOOK NAME">
                        <input type="submit" class="fadeIn fourth" value="Remove Book" name="Remove Book">
                    </form>
                    <?php 
                        if ($error=="error")
                        {
                        echo "<h2>Book Doesnt exist</h2>"; 
                        $error = "";
                        }    
                        echo "$error";   
